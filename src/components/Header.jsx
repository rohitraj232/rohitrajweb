          ...
          <div className="menu-container">
            <div className="logo">
              <Link className="navbar-brand me-0" to="/">
                ...
                <span>Rohit <span className="primary"> Raj</span></span>
              </Link>
            </div>
            <div className={`navbar-main d-flex flex-grow-1 ${menuOpen ? "show" : ""}`}>
            ...
            {menuOpen && (
              <div
                className="mobile-menu-overlay d-block d-xl-none show"
                onClick={closeMenu}
              ></div>
            )}
